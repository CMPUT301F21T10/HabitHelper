...
public class habitEventsCustomList extends RecyclerView.Adapter<habitEventsCustomList.MyEventViewHolder>{
    ...
    @NonNull
    @Override
    public habitEventsCustomList.MyEventViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
//        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.habit_row_contents, parent,false);
        ...
        return new habitEventsCustomList.MyEventViewHolder(view);
    }


    @Override
    public void onBindViewHolder(@NonNull habitEventsCustomList.MyEventViewHolder holder, @SuppressLint("RecyclerView") int position) {
